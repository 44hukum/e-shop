...
import 'package:e_shop/Widgets/product_increment_decrement.dart';
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  //FOR DISCOURNT IF ANY
                  Row(
                    children: model.discount !=null? [
                      Container(
...
addItemToCart(String shortInfoAsID, BuildContext context) {
  ...
  // print(EcommerceApp.sharedPreferences.getStringList(EcommerceApp.userCartList).map((e) =>
  //   e.split(',')
  //
  // ));
  ...
  EcommerceApp.firestore
      ...
      .update({EcommerceApp.userCartList: tempCartList,
  }).then((v) {
